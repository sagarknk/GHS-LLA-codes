function Multi_start_point_Fixed_tau_HS_LLA_Cauchy(data_idx, n_EMs, n, q, prec_struc)
    ...
    FileName=['./Results/HS_LLA_cauchy_mix_Workspace_of_',num2str(data_idx),'st_data_set_with_',num2str(n_EMs),...
